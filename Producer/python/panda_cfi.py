...
panda = cms.EDAnalyzer('PandaProducer',
    ...
    fillers = cms.untracked.PSet(
        ...
        ak4GenJets = cms.untracked.PSet(
            ...
            minPt = cms.untracked.double(15.),
            genBHadJetIndex = cms.untracked.string('matchGenBHadron:genBHadJetIndex'),
            genBHadFlavour = cms.untracked.string('matchGenBHadron:genBHadFlavour'),
            genBHadFromTopWeakDecay = cms.untracked.string('matchGenBHadron:genBHadFromTopWeakDecay'),
            genBHadPlusMothers = cms.untracked.string('matchGenBHadron:genBHadPlusMothers'),
            genBHadPlusMothersIndices = cms.untracked.string('matchGenBHadron:genBHadPlusMothersIndices'),
            genBHadIndex = cms.untracked.string('matchGenBHadron:genBHadIndex'),
            genBHadLeptonHadronIndex = cms.untracked.string('matchGenBHadron:genBHadLeptonHadronIndex'),
            genBHadLeptonViaTau = cms.untracked.string('matchGenBHadron:genBHadLeptonViaTau'),
            genCHadJetIndex = cms.untracked.string('matchGenCHadron:genCHadJetIndex'),
            genCHadFlavour = cms.untracked.string('matchGenCHadron:genCHadFlavour'),
            genCHadFromTopWeakDecay = cms.untracked.string('matchGenCHadron:genCHadFromTopWeakDecay'),
            genCHadBHadronId = cms.untracked.string('matchGenCHadron:genCHadBHadronId'),
            genCHadPlusMothers = cms.untracked.string('matchGenCHadron:genCHadPlusMothers'),
            genCHadPlusMothersIndices = cms.untracked.string('matchGenCHadron:genCHadPlusMothersIndices'),
            genCHadIndex = cms.untracked.string('matchGenCHadron:genCHadIndex'),
            genCHadLeptonHadronIndex = cms.untracked.string('matchGenCHadron:genCHadLeptonHadronIndex'),
            genCHadLeptonViaTau = cms.untracked.string('matchGenCHadron:genCHadLeptonViaTau'),
        ),
