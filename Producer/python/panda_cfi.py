...
panda = cms.EDAnalyzer('PandaProducer',
    ...
    fillers = cms.untracked.PSet(
        ...
        chsAK4Jets = cms.untracked.PSet(
            ...
            deepCSVudsg = cms.untracked.string('pfDeepCSVJetTags:probudsg'),
            deepCSVb = cms.untracked.string('pfDeepCSVJetTags:probb'),
            deepCSVc = cms.untracked.string('pfDeepCSVJetTags:probc'),
            deepCSVbb = cms.untracked.string('pfDeepCSVJetTags:probbb'),
            deepCSVcc = cms.untracked.string('pfDeepCSVJetTags:probcc'),
        ...
        chsAK8Jets = cms.untracked.PSet(
            ...
            deepCSVbb = cms.untracked.string('pfDeepCSVJetTags:probbb'),
            deepCSVcc = cms.untracked.string('pfDeepCSVJetTags:probcc'),
            deepCMVAudsg = cms.untracked.string('pfDeepCMVAJetTags:probudsg'),
            deepCMVAb = cms.untracked.string('pfDeepCMVAJetTags:probb'),
            deepCMVAc = cms.untracked.string('pfDeepCMVAJetTags:probc'),
            deepCMVAbb = cms.untracked.string('pfDeepCMVAJetTags:probbb'),
            deepCMVAcc = cms.untracked.string('pfDeepCMVAJetTags:probcc'),
